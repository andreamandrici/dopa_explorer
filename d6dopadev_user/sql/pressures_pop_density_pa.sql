...
DROP TABLE IF EXISTS pressures.pop_density_pa;
CREATE TABLE pressures.pop_density_pa (
wdpaid integer,
...
GRANT ALL ON TABLE pressures.pop_density_pa TO h05mandand;
GRANT ALL ON TABLE pressures.pop_density_pa TO h05ibex;
GRANT SELECT ON TABLE pressures.pop_density_pa TO h05ibexro;

-- CREATE FUNCTION pressures.pop_density_pa
