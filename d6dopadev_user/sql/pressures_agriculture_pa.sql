...
DROP TABLE IF EXISTS pressures.agriculture_pa;
CREATE TABLE pressures.agriculture_pa (
wdpaid integer,
...
GRANT ALL ON TABLE pressures.agriculture_pa TO h05mandand;
GRANT ALL ON TABLE pressures.agriculture_pa TO h05ibex;
GRANT SELECT ON TABLE pressures.agriculture_pa TO h05ibexro;

-- CREATE FUNCTION pressures.agriculture_pa
